...
[properPET1]:       ./img/ct-celesteion-overview-accuracy-2.png "img"
[properPET2]:       ./img/f2big.png "img"
[easyPET1]:         ./img/IMG_20171012_152431.jpg "img"
[easyPETsoftware]:  ./img/IMG_20171012_151940.jpg "img"
[easyPETtopBottom]: ./img/topBottom.jpg "img"
[easyPETeasy]:      ./img/easy.jpg "img"
...
![alt text][easyPET1]
![alt text][easyPETsoftware]
![alt text][easyPETtopBottom]
![alt text][easyPETeasy]
...
[processed600mVBoxSrc]: ./img/processed.png "img"

Check it out:

<center>
![alt text][processed600mVBoxSrc]
</center>
...
[petSlice]: ./img/petScanPictures3.jpg "img"
[petVoxel]: ./img/rat-mri-enlarge.jpg "img"
...
We'll start by discussing stuff that you already know about PET scanners and we'll keep talking about them until we reach topics that you probably didn't know previously. Then we'll continue talking. For a while. It might be interesting. That's the first half of the lecture. The second half will be about our experiment per se. When we get to the second half we'll talk about the structure of that one as well, but we're getting ahead of ourselves here. The first half will focus on going into detail about answering two questions: what is a PET scanner, and how good are they? Given what we've talked about so far, one can infer that the answer to the first question will have the following components:
...
[coolImage]:    ./img/PETscanSchematic.jpg "img"
[mousePETscan]: ./img/G8_PET-CT-Imaging-Mouse-Web.jpg "img"
...
[glucose]:               ./img/Alpha-D-glucopyranose-2D-skeletal.png "img"
[FDG]:                   ./img/Fluorodeoxyglucose_18-F_skeletal.svg.png "img"
[18Fdecay]:              ./img/800px-F18_DS1.png "img"
[positronKineticEnergy]: ./img/18FpositronKineticEnergy.png "img"
[epAnnihilationFeynman]: ./img/640px-Feynman_EP_Annihilation.svg.png
[epAnnihilation]:        ./img/main-qimg-a4b1776e6a338cb836e591602ac782a1-c.jpg "img"
[positronCrossSection]:  ./img/peAnnihilationCrossSection.png "img"
[positronRangeWater]:    ./img/positronRangeWater.png "img"
[H2OgammaAttenuation]:   ./img/H2OgammaAttenuation.png "img"
[fullMechanism]:         ./img/Annihilation.png "img"
[PETonWheels]:           ./img/PETonWheels.png "img"
[noncolinearity]:        ./img/noncolinearity.png "img"
[mechanismLargeScale]:   ./img/mechanismLargeScale.png "img"
[mechanismLargerScale]:  ./img/mechanismLargerScale.png "img"
[orange]:                ./img/orange.png "img"
...
<center>
 ...
 <center>![alt text][glucose]</center> | <center>![alt text][FDG]</center>
:-------------------------------------:|:------------------------------------:
 <center>**glucose**</center>          | <center>**FDG**</center>
...
<center>
![alt text][positronKineticEnergy]
...
<center>
![alt text][epAnnihilationFeynman]
</center>
...
<center>
![alt text][mechanismLargeScale]
</center>

And we can map out multiple LORs! 

<center>
![alt text][mechanismLargerScale]
</center>
...
[mechanismLargerScaleZoom]: ./img/mechanismLargerScaleZoom.png "img"
[linearAttenuation]:        ./img/massAttenuatio.png "img"
[bandStructure]:            ./img/bandStructure.png "img"
[scintBandStruct]:          ./img/Energy+band+structure+of+an+activated+cystalline+scintillator.jpg "img"
[scintillatorTable]:        ./img/scintillatorTable.png "img"
[tumors]:                   ./img/333643_1_En_4_Fig7_HTML.gif "img"
[scintillatorOutput]:       ./img/scintillatorOutput.png "img"
...
<center>
![alt text][mechanismLargerScaleZoom]
</center>
...
[wellBehavedSignal]:       ./img/wellBehavedSignal.png "img"
[PMToutput]:               ./img/PMToutput.png "img"
[coincidenceDetection]:    ./img/coincidenceDetection.png "img"
[sinogram1]:               ./img/causes-of-noise-in-pet-imaging-4-638.jpg "img"
[sinogram2]:               ./img/technologies-05-00037-g001.png "img"
[backprojection]:          ./img/fig15a.JPG "img"
[filters]:                 ./img/filters.png "img"
[filteredBackprojection]:  ./img/additional-material-24-638.jpg "img"
[reconstructionContents]:  ./img/reconstructionContents.png "img"
[iterativeReconstruction]: ./img/iterativeReconstruction.png "img"
[reconstructionCompar]:    ./img/reconstructionComparison.png "img"
...
<center>
![alt text][filteredBackprojection]
</center>

<center>
![alt text][reconstructionContents]

*source: G. B. Saha, Basics of PET Imaging 2nd Ed., Springer*
</center>

<center>
![alt text][iterativeReconstruction]

*source: G. B. Saha, Basics of PET Imaging 2nd Ed., Springer*
</center>

<center>
![alt text][reconstructionCompar]
...
[uses]:      ./img/uses.png "img"
[personPET]: ./img/PET-Scanner-640x353.jpg "img"
[mousePET]:  ./img/PCIF_SmallanimalPET-CT.jpg "img"
[mousePET2]: ./img/smallAnimalPet.png "img"
